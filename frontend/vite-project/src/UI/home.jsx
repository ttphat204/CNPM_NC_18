        ...
        <div className="mr-32 ml-32 mt-24">
          ...
          <div className="h-52 mt-10 flex justify-between mb-10">
            {["sale1.jpg", "sale2.jpg", "sale3.jpg"].map((imgSrc, idx) => (
              <div
                key={idx}
                className="relative w-96 h-52 overflow-hidden rounded-lg border border-gray-300"
              >
                <img
                  src={imgSrc}
                  className="transition-transform transform hover:scale-110 hover:opacity-50"
                />
